...
class Trainer:
    ...
    def compute_losses(self, model, input, targets):
        ...
        displacement_loss = self.mse(normalized_displacement_hat, targets)
    ...
    def network_validate_step(self, model, dataloader, physics_flag=True):
        ...
        with torch.no_grad():
            for inputs, targets in dataloader:
                ...
                if physics_flag:
                    total_loss += (disp_loss + self.lamda_velocity_int * vel_loss).item()
                else:
    ...
    def _bind_optimizers(self, model):
        ...
        self.network_scheduler = CustomScheduler(
            ...
            minimum_learning_rate=self.cfg.training.network_minimum_lr
        )
        ...
        self.physics_scheduler = CustomScheduler(
            ...
            minimum_learning_rate=self.cfg.training.physics_minimum_lr
        )
